...
package slowly_changing_dimensions.scd_2_0_1;
 ...
 * @status
 */
public class SCD_2 implements TalendJob {
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext() {
			...
			if (MAX_SEQ != null) {
				...
				this.setProperty("MAX_SEQ", MAX_SEQ.toString());
	...
	private final String jobName = "SCD_2";
	private final String projectName = "SLOWLY_CHANGING_DIMENSIONS";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(SCD_2.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
		final static byte[] commonByteArrayLock_SLOWLY_CHANGING_DIMENSIONS_SCD_2 = new byte[0];
		static byte[] commonByteArray_SLOWLY_CHANGING_DIMENSIONS_SCD_2 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_SLOWLY_CHANGING_DIMENSIONS_SCD_2.length) {
					if (length < 1024 && commonByteArray_SLOWLY_CHANGING_DIMENSIONS_SCD_2.length == 0) {
						commonByteArray_SLOWLY_CHANGING_DIMENSIONS_SCD_2 = new byte[1024];
					} else {
						commonByteArray_SLOWLY_CHANGING_DIMENSIONS_SCD_2 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_SLOWLY_CHANGING_DIMENSIONS_SCD_2, 0, length);
				strReturn = new String(commonByteArray_SLOWLY_CHANGING_DIMENSIONS_SCD_2, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_SLOWLY_CHANGING_DIMENSIONS_SCD_2) {
...
///////////////////////    			
				...
				final String decryptedPassword_tDBInput_3 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:peq2fpZ8XaLgEbQ9nEdiq6ikimos9Vu3DMiV4WH6srK3G7Uv");
				...
				String dbquery_tDBInput_3 = "SELECT 'MAX_SEQ',COALESCE(MAX(Address_ID),0) FROM talend.SCD_2_TARGET";
				...
				try {
					...
					while (rs_tDBInput_3.next()) {
						...
						if (colQtyInRs_tDBInput_3 < 1) {
							...
							row3.key = routines.system.JDBCUtil.getString(rs_tDBInput_3, 1, false);
						}
						if (colQtyInRs_tDBInput_3 < 2) {
							row3.value = null;
						} else {

							row3.value = routines.system.JDBCUtil.getString(rs_tDBInput_3, 2, false);
						}
...
///////////////////////    			
						...
						if (tmp_key_tContextLoad_1 != null) {
							try {
								if (key_tContextLoad_1 != null && "MAX_SEQ".equals(key_tContextLoad_1)) {
									context.MAX_SEQ = value_tContextLoad_1;
								}
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final SCD_2 SCD_2Class = new SCD_2();

		int exitCode = SCD_2Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = SCD_2.class.getClassLoader()
					.getResourceAsStream("slowly_changing_dimensions/scd_2_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = SCD_2.class.getClassLoader()
			...
			class ContextProcessing {
				private void processContext_0() {
					context.setContextType("MAX_SEQ", "id_String");
					context.MAX_SEQ = (String) context.getProperty("MAX_SEQ");
				}
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			if (parentContextMap.containsKey("MAX_SEQ")) {
				context.MAX_SEQ = (String) parentContextMap.get("MAX_SEQ");
			}
		}
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SCD_2");
		}
...
/************************************************************************************************
 * 48030 characters generated by Talend Open Studio for Data Integration on the
 * December 16, 2020 10:43:49 PM PKT
 ************************************************************************************************/