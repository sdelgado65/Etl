...
package demo_1.consolidated_customer_data_0_1;
...
/**
 * Job: Consolidated_customer_data Purpose: Get Customer Data<br>
 * Description: to get customer Data from 2 files and join them in one <br>
 * 
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status
 */
public class Consolidated_customer_data implements TalendJob {
	...
	private final String jobName = "Consolidated_customer_data";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Consolidated_customer_data.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Consolidated_customer_data.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
		final static byte[] commonByteArrayLock_DEMO_1_Consolidated_customer_data = new byte[0];
		static byte[] commonByteArray_DEMO_1_Consolidated_customer_data = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DEMO_1_Consolidated_customer_data.length) {
					if (length < 1024 && commonByteArray_DEMO_1_Consolidated_customer_data.length == 0) {
						commonByteArray_DEMO_1_Consolidated_customer_data = new byte[1024];
					} else {
						commonByteArray_DEMO_1_Consolidated_customer_data = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DEMO_1_Consolidated_customer_data, 0, length);
				strReturn = new String(commonByteArray_DEMO_1_Consolidated_customer_data, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEMO_1_Consolidated_customer_data) {
...
// ###############################
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/Talend/TOS_DI-Win32-20200219_1130-V7.3.1/data_file/Customer_city_data.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Talend/TOS_DI-Win32-20200219_1130-V7.3.1/data_file/Customer_city_data.csv",
...
// Start of branch "out1"
							if (out1 != null) {
								...
								arrayRowtSortRow_1_SortOut.ID = out1.ID;
								arrayRowtSortRow_1_SortOut.Cus_name = out1.Cus_name;
								arrayRowtSortRow_1_SortOut.city = out1.city;
					...
					if (!((Object) ("C:/Talend/TOS_DI-Win32-20200219_1130-V7.3.1/data_file/Customer_city_data.csv") instanceof java.io.InputStream)) {
...
// ###############################      
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(
						"C:/Talend/TOS_DI-Win32-20200219_1130-V7.3.1/data_file/output/consolidated_customer_data.csv"))
				...
				for (int i_tSortRow_1_SortIn = 0; i_tSortRow_1_SortIn < array_tSortRow_1_SortIn.length; i_tSortRow_1_SortIn++) {
					...
					row3.Cus_name = current_tSortRow_1_SortIn.Cus_name;
					...
					if (row3.Cus_name != null) {
						sb_tFileOutputDelimited_1.append(row3.Cus_name);
					}
					sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
					if (row3.city != null) {
	...
	public static class row2Struct implements routines.system.IPersistableComparableLookupRow<row2Struct> {
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.Cus_name = readString(dis, ois);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeString(this.Cus_name, dos, oos);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					Object filename_tFileInputDelimited_2 = "C:/Talend/TOS_DI-Win32-20200219_1130-V7.3.1/data_file/Customer_data.csv";
					...
					try {
						fid_tFileInputDelimited_2 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Talend/TOS_DI-Win32-20200219_1130-V7.3.1/data_file/Customer_data.csv", "US-ASCII",
					...
					while (fid_tFileInputDelimited_2 != null && fid_tFileInputDelimited_2.nextRecord()) {
						...
						try {
							...
							row2.Cus_name = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
...
// Start of branch "row2"
						if (row2 != null) {
							...
							row2_HashRow.Cus_name = row2.Cus_name;
					...
					if (!((Object) ("C:/Talend/TOS_DI-Win32-20200219_1130-V7.3.1/data_file/Customer_data.csv") instanceof java.io.InputStream)) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					Object filename_tFileInputDelimited_3 = "C:/Talend/TOS_DI-Win32-20200219_1130-V7.3.1/data_file/Customer_city_data.csv";
					...
					while (fid_tFileInputDelimited_3 != null && fid_tFileInputDelimited_3.nextRecord()) {
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"ID", "row4", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
							...
							row4.city = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
...
// Start of branch "row6"
							if (row6 != null) {
								...
								arrayRowtSortRow_2_SortOut.ID = row6.ID;
								arrayRowtSortRow_2_SortOut.Cus_name = row6.Cus_name;
								arrayRowtSortRow_2_SortOut.city = row6.city;
				...
				fileName_tFileOutputDelimited_2 = (new java.io.File(
						"C:/Talend/TOS_DI-Win32-20200219_1130-V7.3.1/data_file/output/consolidated_customer_data_using_tjoin.csv"))
								.getAbsolutePath().replace("\\", "/");
				...
				for (int i_tSortRow_2_SortIn = 0; i_tSortRow_2_SortIn < array_tSortRow_2_SortIn.length; i_tSortRow_2_SortIn++) {
					...
					row7.ID = current_tSortRow_2_SortIn.ID;
					row7.Cus_name = current_tSortRow_2_SortIn.Cus_name;
					row7.city = current_tSortRow_2_SortIn.city;
					// increase number of line sorted
					...
					if (row7.ID != null) {
						sb_tFileOutputDelimited_2.append(row7.ID);
					}
					sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
					if (row7.Cus_name != null) {
						sb_tFileOutputDelimited_2.append(row7.Cus_name);
					}
					sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
					if (row7.city != null) {
						sb_tFileOutputDelimited_2.append(row7.city);
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					Object filename_tFileInputDelimited_4 = "C:/Talend/TOS_DI-Win32-20200219_1130-V7.3.1/data_file/Customer_data.csv";
					...
					while (fid_tFileInputDelimited_4 != null && fid_tFileInputDelimited_4.nextRecord()) {
						...
						try {
							...
							row5.Cus_name = fid_tFileInputDelimited_4.get(columnIndexWithD_tFileInputDelimited_4);
...
// Start of branch "row5"
						if (row5 != null) {
							...
							row5_HashRow.Cus_name = row5.Cus_name;
	...
	public static void main(String[] args) {
		final Consolidated_customer_data Consolidated_customer_dataClass = new Consolidated_customer_data();

		int exitCode = Consolidated_customer_dataClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Consolidated_customer_data.class.getClassLoader().getResourceAsStream(
					"demo_1/consolidated_customer_data_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Consolidated_customer_data.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Consolidated_customer_data");
		}
...
/************************************************************************************************
 * 146156 characters generated by Talend Open Studio for Data Integration on the
 * December 9, 2020 12:33:33 AM PKT
 ************************************************************************************************/