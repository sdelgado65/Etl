...
package data_to_td.loadmultiplefilestoteradata_0_1;
...
/**
 * Job: LoadMultipleFilesToTeradata Purpose: <br>
 * Description: Will be loading multiple files in which some will also be joined
 * and will be in a single table <br>
 * 
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status
 */
public class LoadMultipleFilesToTeradata implements TalendJob {
	...
	private final String jobName = "LoadMultipleFilesToTeradata";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					LoadMultipleFilesToTeradata.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(LoadMultipleFilesToTeradata.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
		final static byte[] commonByteArrayLock_DATA_TO_TD_LoadMultipleFilesToTeradata = new byte[0];
		static byte[] commonByteArray_DATA_TO_TD_LoadMultipleFilesToTeradata = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DATA_TO_TD_LoadMultipleFilesToTeradata.length) {
					if (length < 1024 && commonByteArray_DATA_TO_TD_LoadMultipleFilesToTeradata.length == 0) {
						commonByteArray_DATA_TO_TD_LoadMultipleFilesToTeradata = new byte[1024];
					} else {
						commonByteArray_DATA_TO_TD_LoadMultipleFilesToTeradata = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DATA_TO_TD_LoadMultipleFilesToTeradata, 0, length);
				strReturn = new String(commonByteArray_DATA_TO_TD_LoadMultipleFilesToTeradata, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DATA_TO_TD_LoadMultipleFilesToTeradata) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String tableName_tDBOutput_1 = "talend_customer";
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:tLNHlTQ25KJOm/v/yXnav3Nxsm/KErsJFoofs8VwRhV5G2qI1A==");
				...
				if (dbname_tDBOutput_1 == null || dbname_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = "talend_customer";
				} else {
					tableName_tDBOutput_1 = dbname_tDBOutput_1 + "\".\"" + "talend_customer";
				}
				int count_tDBOutput_1 = 0;
				conn_tDBOutput_1.commit();
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
						+ "\" (\"ID\",\"Cus_name\",\"City\",\"Salary\") VALUES (?,?,?,?)";
...
// ###############################
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */
						"C:/Talend/TOS_DI-Win32-20200219_1130-V7.3.1/data_file/Customer_Address.csv"/**
																									 * End field
...
// Start of branch "out1"
							if (out1 != null) {
								...
								if (out1.Salary == null) {
									...
									pstmt_tDBOutput_1.setInt(4, out1.Salary);
								}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				Object filename_tFileInputDelimited_2 = /** Start field tFileInputDelimited_2:FILENAME */
						"C:/Talend/TOS_DI-Win32-20200219_1130-V7.3.1/data_file/Customer.csv"/**
																							 * End field
						...
						try {
							...
							if (rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])) {// empty
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row2.Cus_name = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				Object filename_tFileInputDelimited_3 = /** Start field tFileInputDelimited_3:FILENAME */
						"C:/Talend/TOS_DI-Win32-20200219_1130-V7.3.1/data_file/Customer_Salary.csv"/**
																									 * End field
								...
								if (columnIndexWithD_tFileInputDelimited_3 < rowtFileInputDelimited_3.length) {
									...
									if (rowtFileInputDelimited_3[columnIndexWithD_tFileInputDelimited_3].length() > 0) {
										try {
											...
											row3.Salary = ParserUtils.parseTo_Integer(
													rowtFileInputDelimited_3[columnIndexWithD_tFileInputDelimited_3]);
...
// Start of branch "row3"
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbProperties_tDBConnection_1 == null || dbProperties_tDBConnection_1.trim().length() == 0) {
					url_tDBConnection_1 = "jdbc:teradata://" + "192.168.197.128" + "/DATABASE=" + "demo_user";
				} else {
					url_tDBConnection_1 = "jdbc:teradata://" + "192.168.197.128" + "/DATABASE=" + "demo_user" + ","
							+ "";
				}
				String dbUser_tDBConnection_1 = "demo_user";

				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:DI5Kf4hhUtJTVbtDQkiIjuizot3FoUq+EMIn8zLGycG/MDz4zw==");
				...
				globalMap.put("dbname_tDBConnection_1", "demo_user");
	...
	public static void main(String[] args) {
		final LoadMultipleFilesToTeradata LoadMultipleFilesToTeradataClass = new LoadMultipleFilesToTeradata();

		int exitCode = LoadMultipleFilesToTeradataClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = LoadMultipleFilesToTeradata.class.getClassLoader().getResourceAsStream(
					"data_to_td/loadmultiplefilestoteradata_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = LoadMultipleFilesToTeradata.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : LoadMultipleFilesToTeradata");
		}
...
/************************************************************************************************
 * 123131 characters generated by Talend Open Studio for Data Integration on the
 * December 14, 2020 10:24:05 PM PKT
 ************************************************************************************************/