...
package data_to_td.generatingdata_0_1;
...
/**
 * Job: GeneratingData Purpose: <br>
 * Description: will generate quite a large amount of data <br>
 * 
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status
 */
public class GeneratingData implements TalendJob {
	...
	private final String jobName = "GeneratingData";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					GeneratingData.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(GeneratingData.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_DATA_TO_TD_GeneratingData = new byte[0];
		static byte[] commonByteArray_DATA_TO_TD_GeneratingData = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DATA_TO_TD_GeneratingData.length) {
					if (length < 1024 && commonByteArray_DATA_TO_TD_GeneratingData.length == 0) {
						commonByteArray_DATA_TO_TD_GeneratingData = new byte[1024];
					} else {
						commonByteArray_DATA_TO_TD_GeneratingData = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DATA_TO_TD_GeneratingData, 0, length);
				strReturn = new String(commonByteArray_DATA_TO_TD_GeneratingData, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DATA_TO_TD_GeneratingData) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(
						"C:/Talend/TOS_DI-Win32-20200219_1130-V7.3.1/data_file/output/CustomerDataLarge.csv"))
				...
				int nb_max_row_tRowGenerator_1 = 10000000;
				...
				for (int itRowGenerator_1 = 0; itRowGenerator_1 < nb_max_row_tRowGenerator_1; itRowGenerator_1++) {
					...
					row1.FName = randtRowGenerator_1.getRandomFName();
					row1.LName = randtRowGenerator_1.getRandomLName();
					...
					if (row1.FName != null) {
						sb_tFileOutputDelimited_1.append(row1.FName);
					}
					sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
					if (row1.LName != null) {
						sb_tFileOutputDelimited_1.append(row1.LName);
					}
					sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
					if (row1.City != null) {
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("ID=" + String.valueOf(ID));
			sb.append(",ID1=" + String.valueOf(ID1));
	...
	public void tRowGenerator_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				int nb_max_row_tRowGenerator_2 = 10000000;
				...
				class tRowGenerator_2Randomizer {
					...
					public Integer getRandomSalary() {
						...
						return Numeric.random(1000, 9999);
				...
				for (int itRowGenerator_2 = 0; itRowGenerator_2 < nb_max_row_tRowGenerator_2; itRowGenerator_2++) {
					row2.ID = randtRowGenerator_2.getRandomID();
					row2.ID1 = randtRowGenerator_2.getRandomID1();
					row2.Salary = randtRowGenerator_2.getRandomSalary();
					...
					if (row2.ID != null) {
						sb_tFileOutputDelimited_2.append(row2.ID);
					}
					sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
					if (row2.ID1 != null) {
						sb_tFileOutputDelimited_2.append(row2.ID1);
					}
					sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
					if (row2.Salary != null) {
						sb_tFileOutputDelimited_2.append(row2.Salary);
					}
	...
	public static void main(String[] args) {
		final GeneratingData GeneratingDataClass = new GeneratingData();

		int exitCode = GeneratingDataClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = GeneratingData.class.getClassLoader()
					.getResourceAsStream("data_to_td/generatingdata_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = GeneratingData.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : GeneratingData");
		}
...
/************************************************************************************************
 * 54860 characters generated by Talend Open Studio for Data Integration on the
 * December 15, 2020 12:50:56 AM PKT
 ************************************************************************************************/