...
package demo_staging_finance.move_files_from_target_0_1;
...
/**
 * Job: MOVE_FILES_FROM_TARGET Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class MOVE_FILES_FROM_TARGET implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "MOVE_FILES_FROM_TARGET";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				MOVE_FILES_FROM_TARGET.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(MOVE_FILES_FROM_TARGET.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  String directory_tFileList_1 = "C:/Talend/TOS_DI-Win32-20200219_1130-V7.3.1/data_file/Banking/New_Banking_Data";
 ...
 */
	...
	currentComponent="tFileCopy_1";
        ...
        String desDirName_tFileCopy_1 = "C:/Talend/TOS_DI-Win32-20200219_1130-V7.3.1/data_file/Banking/Archive/"+TalendDate.formatDate("yyyy_MM_dd_HH_mm_ss",TalendDate.getCurrentDate());

		String desFileName_tFileCopy_1 =  ((String)globalMap.get("tFileList_1_CURRENT_FILE")) ;
 ...
 */
    ...
    public static void main(String[] args){
        final MOVE_FILES_FROM_TARGET MOVE_FILES_FROM_TARGETClass = new MOVE_FILES_FROM_TARGET();

        int exitCode = MOVE_FILES_FROM_TARGETClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = MOVE_FILES_FROM_TARGET.class.getClassLoader().getResourceAsStream("demo_staging_finance/move_files_from_target_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = MOVE_FILES_FROM_TARGET.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : MOVE_FILES_FROM_TARGET");
        }
...
/************************************************************************************************
 *     32612 characters generated by Talend Open Studio for Data Integration 
 *     on the January 29, 2021 3:18:58 PM PKT
 ************************************************************************************************/