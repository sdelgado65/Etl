...
package demo_staging_finance.full_contact_job_0_1;
...
/**
 * Job: Full_Contact_Job Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class Full_Contact_Job implements TalendJob {
	...
	private final String jobName = "Full_Contact_Job";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Full_Contact_Job.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Full_Contact_Job.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				demo_staging_finance.loadcontact_0_1.LoadContact childJob_tRunJob_1 = new demo_staging_finance.loadcontact_0_1.LoadContact();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				demo_staging_finance.contact_stg_to_ldr_0_1.Contact_STG_To_LDR childJob_tRunJob_2 = new demo_staging_finance.contact_stg_to_ldr_0_1.Contact_STG_To_LDR();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				demo_staging_finance.copy_of_contact_iud_ldr_core_scd_2_checking_0_1.Copy_of_Contact_IUD_LDR_CORE_SCD_2_CHECKING childJob_tRunJob_3 = new demo_staging_finance.copy_of_contact_iud_ldr_core_scd_2_checking_0_1.Copy_of_Contact_IUD_LDR_CORE_SCD_2_CHECKING();
				// pass DataSources
	...
	public static void main(String[] args) {
		final Full_Contact_Job Full_Contact_JobClass = new Full_Contact_Job();

		int exitCode = Full_Contact_JobClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Full_Contact_Job.class.getClassLoader().getResourceAsStream(
					"demo_staging_finance/full_contact_job_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Full_Contact_Job.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Full_Contact_Job");
		}
...
/************************************************************************************************
 * 42617 characters generated by Talend Open Studio for Data Integration on the
 * January 12, 2021 12:46:55 AM PKT
 ************************************************************************************************/