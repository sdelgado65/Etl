...
package demo_staging_finance.staging_generating_help_tables_0_1;
...
/**
 * Job: Staging_Generating_Help_Tables Purpose: <br>
 * Description: Here we will combine the jobs of the staging and also then
 * generate the help tables from that. <br>
 * 
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status
 */
public class Staging_Generating_Help_Tables implements TalendJob {
	...
	private final String jobName = "Staging_Generating_Help_Tables";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Staging_Generating_Help_Tables.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Staging_Generating_Help_Tables.this,
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				demo_staging_finance.loadaccounts_0_1.LoadAccounts childJob_tRunJob_1 = new demo_staging_finance.loadaccounts_0_1.LoadAccounts();
				// pass DataSources
	...
	public void tRunJob_9Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				demo_staging_finance.help_table_accounttype_0_1.Help_Table_AccountType childJob_tRunJob_9 = new demo_staging_finance.help_table_accounttype_0_1.Help_Table_AccountType();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				demo_staging_finance.loadaddress_0_1.LoadAddress childJob_tRunJob_2 = new demo_staging_finance.loadaddress_0_1.LoadAddress();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				demo_staging_finance.loadbank_0_1.LoadBank childJob_tRunJob_3 = new demo_staging_finance.loadbank_0_1.LoadBank();
				// pass DataSources
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				demo_staging_finance.loadbranch_0_1.LoadBranch childJob_tRunJob_4 = new demo_staging_finance.loadbranch_0_1.LoadBranch();
				// pass DataSources
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				demo_staging_finance.loadcity_0_1.LoadCity childJob_tRunJob_5 = new demo_staging_finance.loadcity_0_1.LoadCity();
				// pass DataSources
	...
	public void tRunJob_6Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				demo_staging_finance.loadcontact_0_1.LoadContact childJob_tRunJob_6 = new demo_staging_finance.loadcontact_0_1.LoadContact();
				// pass DataSources
	...
	public void tRunJob_10Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				demo_staging_finance.help_tables_contact_0_1.Help_Tables_Contact childJob_tRunJob_10 = new demo_staging_finance.help_tables_contact_0_1.Help_Tables_Contact();
				// pass DataSources
	...
	public void tRunJob_7Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				demo_staging_finance.loadcountry_0_1.LoadCountry childJob_tRunJob_7 = new demo_staging_finance.loadcountry_0_1.LoadCountry();
				// pass DataSources
	...
	public void tRunJob_8Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				demo_staging_finance.loadtransactions_0_1.LoadTransactions childJob_tRunJob_8 = new demo_staging_finance.loadtransactions_0_1.LoadTransactions();
				// pass DataSources
	...
	public void tRunJob_11Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				demo_staging_finance.help_table_transactions_0_1.Help_Table_Transactions childJob_tRunJob_11 = new demo_staging_finance.help_table_transactions_0_1.Help_Table_Transactions();
				// pass DataSources
	...
	public static void main(String[] args) {
		final Staging_Generating_Help_Tables Staging_Generating_Help_TablesClass = new Staging_Generating_Help_Tables();

		int exitCode = Staging_Generating_Help_TablesClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Staging_Generating_Help_Tables.class.getClassLoader().getResourceAsStream(
					"demo_staging_finance/staging_generating_help_tables_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Staging_Generating_Help_Tables.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Staging_Generating_Help_Tables");
		}
...
/************************************************************************************************
 * 98702 characters generated by Talend Open Studio for Data Integration on the
 * January 14, 2021 12:19:12 AM PKT
 ************************************************************************************************/