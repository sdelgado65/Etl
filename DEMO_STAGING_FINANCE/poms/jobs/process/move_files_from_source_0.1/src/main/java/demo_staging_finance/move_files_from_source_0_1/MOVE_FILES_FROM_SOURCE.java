...
package demo_staging_finance.move_files_from_source_0_1;
...
/**
 * Job: MOVE_FILES_FROM_SOURCE Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class MOVE_FILES_FROM_SOURCE implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "MOVE_FILES_FROM_SOURCE";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				MOVE_FILES_FROM_SOURCE.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(MOVE_FILES_FROM_SOURCE.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	NB_ITERATE_tFileList_1++;
				...
				if(execStat){
					runStat.updateStatOnConnection("iterate3", 1, "exec" + NB_ITERATE_tFileList_1);
					//Thread.sleep(1000);
				}				
 ...
 */
	...
	currentComponent="tFileCopy_1";
        ...
        String desDirName_tFileCopy_1 = "C:/Talend/TOS_DI-Win32-20200219_1130-V7.3.1/data_file/Banking/New_Banking_Data";
 ...
 */
						if(execStat){
							runStat.updateStatOnConnection("iterate3", 2, "exec" + NB_ITERATE_tFileList_1);
						}				
...
public static class OnSubjobOkStructtIterateToFlow_1 implements routines.system.IPersistableRow<OnSubjobOkStructtIterateToFlow_1> {
    final static byte[] commonByteArrayLock_DEMO_STAGING_FINANCE_MOVE_FILES_FROM_SOURCE = new byte[0];
    static byte[] commonByteArray_DEMO_STAGING_FINANCE_MOVE_FILES_FROM_SOURCE = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DEMO_STAGING_FINANCE_MOVE_FILES_FROM_SOURCE) {
 ...
 */
	NB_ITERATE_tFileList_2++;
				...
				if(execStat){
					runStat.updateStatOnConnection("iterate4", 1, "exec" + NB_ITERATE_tFileList_2);
					//Thread.sleep(1000);
				}				
  ...
  String directory_tFileList_2 = "C:/Talend/TOS_DI-Win32-20200219_1130-V7.3.1/data_file/Source_Files";
...
struct_tIterateToFlow_1_ITFO.Value  = ((Integer)globalMap.get("tFileList_2_NB_FILE"));
 ...
 */
						if(execStat){
							runStat.updateStatOnConnection("iterate4", 2, "exec" + NB_ITERATE_tFileList_2);
						}				
 ...
 */
				    			...
				    			if(resumeEntryMethodName == null || globalResumeTicket){
				    				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tInfiniteLoop_2:OnSubjobOk", "", Thread.currentThread().getId() + "", "", "", "", "", "");
								}	    				    			
...
System.out.println((Integer)globalMap.get("tFileList_2_NB_FILE"));
 ...
 */
	...
	currentComponent="tIterateToFlow_1_AI";
        ...
        for(OnSubjobOkStructtIterateToFlow_1 row_tIterateToFlow_1_AI : list_tIterateToFlow_1_AI){
    						...
    						row1.Value = row_tIterateToFlow_1_AI.Value;
 ...
 */
    ...
    public static void main(String[] args){
        final MOVE_FILES_FROM_SOURCE MOVE_FILES_FROM_SOURCEClass = new MOVE_FILES_FROM_SOURCE();

        int exitCode = MOVE_FILES_FROM_SOURCEClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = MOVE_FILES_FROM_SOURCE.class.getClassLoader().getResourceAsStream("demo_staging_finance/move_files_from_source_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = MOVE_FILES_FROM_SOURCE.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
try {
errorCode = null;tInfiniteLoop_1Process(globalMap);
...
try {
errorCode = null;tInfiniteLoop_2Process(globalMap);
if(!"failure".equals(status)) { status = "end"; }
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : MOVE_FILES_FROM_SOURCE");
        }
...
/************************************************************************************************
 *     60370 characters generated by Talend Open Studio for Data Integration 
 *     on the January 14, 2021 7:36:41 PM PKT
 ************************************************************************************************/