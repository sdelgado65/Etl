...
package demo_staging_finance.trigger_stg_jobs_0_1;
...
/**
 * Job: TRIGGER_STG_JOBS Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class TRIGGER_STG_JOBS implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "TRIGGER_STG_JOBS";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				TRIGGER_STG_JOBS.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(TRIGGER_STG_JOBS.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_DEMO_STAGING_FINANCE_TRIGGER_STG_JOBS = new byte[0];
    static byte[] commonByteArray_DEMO_STAGING_FINANCE_TRIGGER_STG_JOBS = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DEMO_STAGING_FINANCE_TRIGGER_STG_JOBS) {
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DEMO_STAGING_FINANCE_TRIGGER_STG_JOBS.length) {
				if(length < 1024 && commonByteArray_DEMO_STAGING_FINANCE_TRIGGER_STG_JOBS.length == 0) {
   					commonByteArray_DEMO_STAGING_FINANCE_TRIGGER_STG_JOBS = new byte[1024];
				} else {
   					commonByteArray_DEMO_STAGING_FINANCE_TRIGGER_STG_JOBS = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DEMO_STAGING_FINANCE_TRIGGER_STG_JOBS, 0, length);
			strReturn = new String(commonByteArray_DEMO_STAGING_FINANCE_TRIGGER_STG_JOBS, 0, length, utf8Charset);
		}
		return strReturn;
	}
 ...
 */
	...
	currentComponent="tWaitForFile_1";
		...
		row1.CURRENT_ITERATION = ((Integer)globalMap.get("tWaitForFile_1_CURRENT_ITERATION"));	
		row1.PRESENT_FILE = ((String)globalMap.get("tWaitForFile_1_PRESENT_FILE"));	
		row1.DELETED_FILE = ((String)globalMap.get("tWaitForFile_1_DELETED_FILE"));	
		row1.CREATED_FILE = ((String)globalMap.get("tWaitForFile_1_CREATED_FILE"));	
		row1.UPDATED_FILE = ((String)globalMap.get("tWaitForFile_1_UPDATED_FILE"));	
		row1.FILENAME = ((String)globalMap.get("tWaitForFile_1_FILENAME"));	
		row1.NOT_UPDATED_FILE = ((String)globalMap.get("tWaitForFile_1_NOT_UPDATED_FILE"));            
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		demo_staging_finance.full_stg_job_0_1.Full_STG_Job childJob_tRunJob_1 = new demo_staging_finance.full_stg_job_0_1.Full_STG_Job();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		demo_staging_finance.move_files_from_target_0_1.MOVE_FILES_FROM_TARGET childJob_tRunJob_2 = new demo_staging_finance.move_files_from_target_0_1.MOVE_FILES_FROM_TARGET();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final TRIGGER_STG_JOBS TRIGGER_STG_JOBSClass = new TRIGGER_STG_JOBS();

        int exitCode = TRIGGER_STG_JOBSClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = TRIGGER_STG_JOBS.class.getClassLoader().getResourceAsStream("demo_staging_finance/trigger_stg_jobs_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = TRIGGER_STG_JOBS.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : TRIGGER_STG_JOBS");
        }
...
/************************************************************************************************
 *     50028 characters generated by Talend Open Studio for Data Integration 
 *     on the January 13, 2021 6:46:06 PM PKT
 ************************************************************************************************/