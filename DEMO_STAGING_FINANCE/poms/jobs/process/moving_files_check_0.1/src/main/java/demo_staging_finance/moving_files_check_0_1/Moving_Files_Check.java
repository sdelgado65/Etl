...
package demo_staging_finance.moving_files_check_0_1;
...
/**
 * Job: Moving_Files_Check Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Moving_Files_Check implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Moving_Files_Check";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Moving_Files_Check.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Moving_Files_Check.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final Moving_Files_Check Moving_Files_CheckClass = new Moving_Files_Check();

        int exitCode = Moving_Files_CheckClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Moving_Files_Check.class.getClassLoader().getResourceAsStream("demo_staging_finance/moving_files_check_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Moving_Files_Check.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Moving_Files_Check");
        }
...
/************************************************************************************************
 *     32461 characters generated by Talend Open Studio for Data Integration 
 *     on the January 29, 2021 3:18:44 PM PKT
 ************************************************************************************************/