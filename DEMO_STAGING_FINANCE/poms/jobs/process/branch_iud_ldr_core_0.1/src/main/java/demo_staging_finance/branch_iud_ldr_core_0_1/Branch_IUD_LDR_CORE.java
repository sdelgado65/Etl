...
package demo_staging_finance.branch_iud_ldr_core_0_1;
...
/**
 * Job: Branch_IUD_LDR_CORE Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class Branch_IUD_LDR_CORE implements TalendJob {
	...
	private final String jobName = "Branch_IUD_LDR_CORE";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Branch_IUD_LDR_CORE.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Branch_IUD_LDR_CORE.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row6Struct implements routines.system.IPersistableRow<row6Struct> {
		final static byte[] commonByteArrayLock_DEMO_STAGING_FINANCE_Branch_IUD_LDR_CORE = new byte[0];
		static byte[] commonByteArray_DEMO_STAGING_FINANCE_Branch_IUD_LDR_CORE = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DEMO_STAGING_FINANCE_Branch_IUD_LDR_CORE.length) {
					if (length < 1024 && commonByteArray_DEMO_STAGING_FINANCE_Branch_IUD_LDR_CORE.length == 0) {
						commonByteArray_DEMO_STAGING_FINANCE_Branch_IUD_LDR_CORE = new byte[1024];
					} else {
						commonByteArray_DEMO_STAGING_FINANCE_Branch_IUD_LDR_CORE = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DEMO_STAGING_FINANCE_Branch_IUD_LDR_CORE, 0, length);
				strReturn = new String(commonByteArray_DEMO_STAGING_FINANCE_Branch_IUD_LDR_CORE, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEMO_STAGING_FINANCE_Branch_IUD_LDR_CORE) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:fwQrgyGbryN/eEExfQ2WAj383tj1VSMUerMwg4ourNwOoW+F");
				...
				final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:S3UFG+Z/D33mixhCVXfshpI9/aTQkIZhjYITbqNL8qyjw00V");
				...
				String update_tDBOutput_2 = "UPDATE \"" + tableName_tDBOutput_2
						+ "\" SET \"IUD\" = ?,\"Branch_Name\" = ?,\"Telephone\" = ?,\"Address_ID\" = ? WHERE \"Branch_Code\" = ?";
...
// ###############################
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:9vbspT5LOCCPo26uY/xQwDslTi2C7uHwwa4hjIPJbORkHD3y");
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 2) {
							...
							row1.Branch_Code = rs_tDBInput_1.getInt(2);
							if (rs_tDBInput_1.wasNull()) {
						...
						if (colQtyInRs_tDBInput_1 < 3) {
							...
							row1.Branch_Name = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
						}
						if (colQtyInRs_tDBInput_1 < 4) {
							row1.Telephone = null;
						} else {

							row1.Telephone = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
						}
						if (colQtyInRs_tDBInput_1 < 5) {
							row1.Address_ID = null;
						} else {

							row1.Address_ID = rs_tDBInput_1.getInt(5);
							if (rs_tDBInput_1.wasNull()) {
								row1.Address_ID = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 6) {
							...
							row1.Bank_ID = rs_tDBInput_1.getInt(6);
							if (rs_tDBInput_1.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							Object exprKeyValue_row2__Branch_Code_1 = row1.Branch_Code;
							if (exprKeyValue_row2__Branch_Code_1 == null) {
								hasCasePrimitiveKeyWithNull_tMap_1 = true;
							} else {
								row2HashKey.Branch_Code_1 = (int) (Integer) exprKeyValue_row2__Branch_Code_1;
							}
						...
						if (tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
							...
							// and it contains more one result from keys : row2.Branch_Code_1 = '" +
							// row2HashKey.Branch_Code_1 + "'");
						} // G 071
...
// # Filter conditions 
								...
								!(Relational.ISNULL(row2.Branch_Code)) && !row2.Branch_Name.equals(row1.Branch_Name)
										&& (row1.Branch_Code == row2.Branch_Code)
										|| !row2.Address_ID.equals(row1.Address_ID)

								) {
									out2_tmp.IUD = 2;
									out2_tmp.Branch_Code = row1.Branch_Code;
									out2_tmp.Branch_Name = row1.Branch_Name;
									out2_tmp.Telephone = row1.Telephone;
									out2_tmp.Address_ID = row1.Address_ID;
									out2 = out2_tmp;
...
// Start of branch "out1"
						if (out1 != null) {
							...
							if (row5.IUD == null) {
								...
								pstmt_tDBOutput_1.setInt(1, row5.IUD);
							}
...
// Start of branch "out2"
						if (out2 != null) {
							...
							row6.IUD = out2.IUD;
							row6.Branch_Code = out2.Branch_Code;
							row6.Branch_Name = out2.Branch_Name;
							row6.Telephone = out2.Telephone;
							row6.Address_ID = out2.Address_ID;
							...
							if (row6.IUD == null) {
								...
								pstmt_tDBOutput_2.setInt(1, row6.IUD);
							}

							if (row6.Branch_Name == null) {
								pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(2, row6.Branch_Name);
							}

							if (row6.Telephone == null) {
								pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(3, row6.Telephone);
							}

							if (row6.Address_ID == null) {
								pstmt_tDBOutput_2.setNull(4, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_2.setInt(4, row6.Address_ID);
							}

							pstmt_tDBOutput_2.setInt(5 + count_tDBOutput_2, row6.Branch_Code);
...
// ###############################      
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_3 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:omgPKV8OaUaOcNju4pcZ1Br97Bm05+cqtfSpiZxDZEHRuvgD");
				...
				String dbquery_tDBInput_3 = "INSERT INTO Branch_LDR_CORE (Branch_Code, Branch_Name, TelePhone, Address_ID)\nSELECT Branch_Code, Branch_Name, TelePho"
						+ "ne, Address_ID FROM Branch_LDR\nWHERE IUD = 1;";
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBRow_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:nC5RNZV90PAUckp8MwgWA1qGkCUBCy1ExArdLrhtb3BAZn1c");
				...
				final String decryptedPassword_tDBInput_4 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:V5cGC5zjGYtey0OpZ5TfabjgKXg55CNJRor1Q4zobShA/wAm");
				...
				try {
					...
					while (rs_tDBInput_4.next()) {
						...
						query_tDBRow_2 = "UPDATE Branch_LDR_CORE\nSET \nBranch_Name = Branch_LDR.Branch_Name,\nTelePhone = Branch_LDR.TelePhone,\nAddress_ID = Br"
								+ "anch_LDR.Address_ID\nWHERE Branch_LDR_CORE.Branch_Code = Branch_LDR.Branch_Code \nAND Branch_LDR.IUD = 2; ";
	...
	public static class row2Struct implements routines.system.IPersistableComparableLookupRow<row2Struct> {
		...
		public int Branch_Code_1;

		public int getBranch_Code_1() {
			return this.Branch_Code_1;
		}
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + (int) this.Branch_Code_1;
		...
		public boolean equals(Object obj) {
			...
			if (this.Branch_Code_1 != other.Branch_Code_1)
				return false;
		...
		public void copyDataTo(row2Struct other) {
			...
			other.Branch_Code_1 = this.Branch_Code_1;
			other.Branch_Code = this.Branch_Code;
			other.Branch_Name = this.Branch_Name;
			other.Telephone = this.Telephone;
			other.Address_ID = this.Address_ID;
		...
		public void readKeysData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEMO_STAGING_FINANCE_Branch_IUD_LDR_CORE) {
				...
				try {
					...
					this.Branch_Code_1 = dis.readInt();
		...
		public void writeKeysData(ObjectOutputStream dos) {
			try {
				...
				dos.writeInt(this.Branch_Code_1);
		...
		public String toString() {
			...
			sb.append(super.toString());
			sb.append("[");
			sb.append("Branch_Code_1=" + String.valueOf(Branch_Code_1));
			sb.append(",Branch_Code=" + String.valueOf(Branch_Code));
			sb.append(",Branch_Name=" + Branch_Name);
			sb.append(",Telephone=" + Telephone);
			sb.append(",Address_ID=" + String.valueOf(Address_ID));
		...
		public int compareTo(row2Struct other) {
			...
			returnValue = checkNullsAndCompare(this.Branch_Code_1, other.Branch_Code_1);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// linked node: tMap_1 - inputs:(row1,row2) outputs:(out1,out2)
				...
				final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:NI5egvL2ZtzvfRtm3WbIYTeP2+8EfHABevIshAGA7hie9Wgi");
				...
				String dbquery_tDBInput_2 = "SELECT ldr_demo.Branch_LDR_CORE.Branch_Code,\n		ldr_demo.Branch_LDR_CORE.Branch_Code,\n		ldr_demo.Branch_LDR_CORE.Branch_"
						+ "Name,\n		ldr_demo.Branch_LDR_CORE.Telephone,\n		ldr_demo.Branch_LDR_CORE.Address_ID\nFROM	ldr_demo.Branch_LDR_CORE";
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (colQtyInRs_tDBInput_2 < 1) {
							row2.Branch_Code_1 = 0;
						} else {

							row2.Branch_Code_1 = rs_tDBInput_2.getInt(1);
						...
						if (colQtyInRs_tDBInput_2 < 3) {
							...
							row2.Branch_Name = routines.system.JDBCUtil.getString(rs_tDBInput_2, 3, false);
						}
						if (colQtyInRs_tDBInput_2 < 4) {
							row2.Telephone = null;
						} else {

							row2.Telephone = routines.system.JDBCUtil.getString(rs_tDBInput_2, 4, false);
						}
						if (colQtyInRs_tDBInput_2 < 5) {
							row2.Address_ID = null;
						} else {

							row2.Address_ID = rs_tDBInput_2.getInt(5);
							if (rs_tDBInput_2.wasNull()) {
								row2.Address_ID = null;
							}
						}
						...
						row2_HashRow.Branch_Code_1 = row2.Branch_Code_1;
	...
	public static void main(String[] args) {
		final Branch_IUD_LDR_CORE Branch_IUD_LDR_COREClass = new Branch_IUD_LDR_CORE();

		int exitCode = Branch_IUD_LDR_COREClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Branch_IUD_LDR_CORE.class.getClassLoader().getResourceAsStream(
					"demo_staging_finance/branch_iud_ldr_core_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Branch_IUD_LDR_CORE.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Branch_IUD_LDR_CORE");
		}
...
/************************************************************************************************
 * 140401 characters generated by Talend Open Studio for Data Integration on the
 * January 23, 2021 12:44:48 AM PKT
 ************************************************************************************************/