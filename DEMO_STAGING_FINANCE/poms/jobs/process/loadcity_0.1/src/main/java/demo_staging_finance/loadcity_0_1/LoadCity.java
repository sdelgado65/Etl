...
package demo_staging_finance.loadcity_0_1;
...
/**
 * Job: LoadCity Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class LoadCity implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "LoadCity";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(LoadCity.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:1LBPOfzwVZjz7D6qVTMii/e+9pgDx/saPrtARLSyzJwVwA==");
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_DEMO_STAGING_FINANCE_LoadCity = new byte[0];
    static byte[] commonByteArray_DEMO_STAGING_FINANCE_LoadCity = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DEMO_STAGING_FINANCE_LoadCity) {
...
query_tDBRow_1 = " delete from stg_City";
...
public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DEMO_STAGING_FINANCE_LoadCity.length) {
				if(length < 1024 && commonByteArray_DEMO_STAGING_FINANCE_LoadCity.length == 0) {
   					commonByteArray_DEMO_STAGING_FINANCE_LoadCity = new byte[1024];
				} else {
   					commonByteArray_DEMO_STAGING_FINANCE_LoadCity = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DEMO_STAGING_FINANCE_LoadCity, 0, length);
			strReturn = new String(commonByteArray_DEMO_STAGING_FINANCE_LoadCity, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
String tableName_tDBOutput_1 = "stg_city";
boolean whetherReject_tDBOutput_1 = false;
   ...
   int batchSizeCounter_tDBOutput_1=0;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:2tTTzrHRpMi7JVBaECrz1knotsgUm5qlBqS2crffcTJGSg==");
...
if(dbname_tDBOutput_1 == null || dbname_tDBOutput_1.trim().length() == 0) {
    tableName_tDBOutput_1 = "stg_city";
} else {
    tableName_tDBOutput_1 = dbname_tDBOutput_1 + "\".\"" + "stg_city";
}
int count_tDBOutput_1=0;
	 conn_tDBOutput_1.commit();
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"Country_ID\",\"City_ID\",\"Name\") VALUES (?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:BVWHjGuHMwnFR5psq9ydElvlDcP/9zISFooVnA==");
		...
		Object source_tFileInputExcel_1 = "C:/Talend/TOS_DI-Win32-20200219_1130-V7.3.1/data_file/Banking/New_Banking_Data/STG_city.xlsx";
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				curColName_tFileInputExcel_1 = "Country_ID";

				row1.Country_ID = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
...
} else {pstmt_tDBOutput_1.setString(1, out1.Country_ID);
}

                    if(out1.City_ID == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, out1.City_ID);
}

                    if(out1.Name == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, out1.Name);
}
 ...
 */
    ...
    public static void main(String[] args){
        final LoadCity LoadCityClass = new LoadCity();

        int exitCode = LoadCityClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = LoadCity.class.getClassLoader().getResourceAsStream("demo_staging_finance/loadcity_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = LoadCity.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : LoadCity");
        }
...
/************************************************************************************************
 *     86070 characters generated by Talend Open Studio for Data Integration 
